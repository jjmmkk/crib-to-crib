( function() {
    ...
    function path ( type, filepath ) {
        return [ paths[type], filepath ].join( '' );
    }
    ...
    requirejs.config(
        {
            paths: {
                'async': path( 'vendor', 'require.async' ),
                'jquery': path( 'vendor', 'jquery' ),
                'backbone': path( 'vendor', 'backbone' ),
                'backbone.localStorage': path( 'vendor', 'backbone.localStorage' ),
                'underscore': path( 'vendor', 'underscore' ),
